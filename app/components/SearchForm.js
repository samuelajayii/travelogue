...
const SearchForm = ({query}) => {
    ...
    return (
        <div className='flex items-center justify-center' >
            <Form action='/home' scroll={false} className='search-form flex items-center justify-center gap-3 outline-none py-3 px-3 w-[80vw] lg:w-[50vw] pl-10 text-black rounded-full bg-white'>
